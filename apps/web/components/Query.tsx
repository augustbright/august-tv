...
>({
    ...
    if (result.isLoading) {
        return (
            <LoadingComponent
                result={
                    result as QueryObserverLoadingResult<TData, DefaultError>
                }
            />
        );
    }
    ...
    if (result.error) {
        return (
            <ErrorComponent
                result={
                    result as QueryObserverLoadingErrorResult<
                        TData,
                        DefaultError
                    >
                }
    ...
    if (result.isSuccess || result.isRefetchError) {
        return (
            <ErrorBoundary>
                {children(
                    result as DefinedQueryObserverResult<TData, DefaultError>
                )}
            </ErrorBoundary>
        );
    }
