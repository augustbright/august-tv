      ...
      <DialogContent className='gap-8 w-auto max-w-none'>
        ...
        {dialogState.avatar && (
          <div className='flex justify-center'>
            <Avatar className='size-52'>
              <AvatarImage
                src={currentPicture?.medium.publicUrl ?? undefined}
              />
              <AvatarFallback>
                <CameraOff />
              </AvatarFallback>
        ...
        {dialogState.avatarGallery && (
          <div className='flex flex-col gap-2'>
            ...
            <AvatarGallery onSelect={handleSelectPictureFromGallery} />
          </div>
        )}
        ...
        {dialogState.preview && selectedImageUrl && (
          <div className='flex gap-4'>
            ...
            <div className='flex flex-col gap-6'>
              ...
              <div className='flex flex-col gap-2'>
                <h4 className='text-sm font-semibold'>Medium</h4>
                <CroppedImage
              ...
              >
                <Icon
                  icon={Sparkles}
                  loading={
                    isUploadingProfilePicture || isUpdatingProfilePicture
                  }
